...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["categoria_id"])) {
    ...
    $sql = "UPDATE categories SET Name='$name', Status='$status', Entry_Date='$entry_date', Exit_Date='$exit_date' WHERE Code=$categoria_id";

    if ($conn->query($sql) === TRUE) {
        // Los cambios se han guardado correctamente, redirige al usuario a la página de categorías correspondiente
