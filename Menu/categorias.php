...
<body>
    <div class="container">
        <h1 class="mt-4">Tabla de Categorías</h1>
        ...
        <a class="btn btn-primary" href="agregar_categoria.php">
        ...
        <form class="form-inline" action="buscar_categoria.php" method="GET">
            <div class="form-group mx-sm-3 mb-2">
                <input type="text" class="form-control" name="query" placeholder="Buscar categoría...">
            </div>
        ...
        <table id="table-to-export" class="table table-bordered">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM categories LIMIT $inicio, $categoriasPorPagina";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>";
                        echo "<a class='btn btn-primary' href='editar_categoria.php?id=" . $row["Code"] . "'>Editar</a> ";
                        echo "<a class='btn btn-danger' href='eliminar_categoria.php?id=" . $row["Code"] . "'>Eliminar</a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                } else {
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                <?php
                // Consultar la cantidad total de categorías
                $sqlTotal = "SELECT COUNT(*) as total FROM categories";
                ...
                for ($i = 1; $i <= $totalPaginas; $i++) {
                    ...
                    echo "'><a class='page-link' href='categorias.php?pagina=$i'>$i</a></li>";
                }
                ?>
            </ul>
        </nav>
    ...
    <script>
        ...
        function exportToExcel() {
            ...
            XLSX.writeFile(table, 'categorias.xlsx');
        }
