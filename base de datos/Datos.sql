...
INSERT INTO Sales (Nit, Quantity, Client_Code, Client_Name, Sale_Date, Product, Unit_of_Measure, Payment_Type, Order_Number, Invoice_Number, Unit_Price, IVA, Discount, Subtotal, Total_Price) VALUES
('3334445555', 8, 16, 'Santiago Pérez', '2023-10-16', 'Producto P', 'Litros', 'Efectivo', 16, 16, 9.99, 1.50, 1.00, 69.93, 81.42),
('6667778888', 14, 17, 'Alicia Mendoza', '2023-10-17', 'Producto Q', 'Unidades', 'Tarjeta de Crédito', 17, 17, 12.50, 2.25, 1.75, 105.00, 124.50),
('1112223333', 5, 18, 'Gustavo Soto', '2023-10-18', 'Producto R', 'Kilogramos', 'Tarjeta de Débito', 18, 18, 6.75, 1.00, 0.50, 30.38, 38.63),
('9998887777', 9, 19, 'Adriana Guzmán', '2023-10-19', 'Producto S', 'Cajas', 'Efectivo', 19, 19, 14.99, 2.50, 2.00, 112.41, 129.90),
('4445556666', 11, 20, 'Rodrigo Torres', '2023-10-20', 'Producto T', 'Unidades', 'Tarjeta de Crédito', 20, 20, 7.25, 1.25, 1.25, 75.75, 88.50),
('7776665555', 7, 21, 'Verónica Ramírez', '2023-10-21', 'Producto U', 'Litros', 'Efectivo', 21, 21, 11.50, 2.00, 1.50, 80.50, 95.50),
('2223334444', 12, 22, 'Martín López', '2023-10-22', 'Producto V', 'Cajas', 'Tarjeta de Débito', 22, 22, 15.75, 2.75, 2.25, 131.58, 152.58),
('5556667777', 6, 23, 'Susana Ortiz', '2023-10-23', 'Producto W', 'Kilogramos', 'Tarjeta de Crédito', 23, 23, 8.99, 1.75, 1.00, 57.69, 68.44),
('8889990000', 10, 24, 'Javier Sánchez', '2023-10-24', 'Producto X', 'Unidades', 'Efectivo', 24, 24, 13.25, 2.50, 2.00, 118.75, 134.00),
('3334445550', 13, 25, 'Valeria Márquez', '2023-10-25', 'Producto Y', 'Cajas', 'Tarjeta de Débito', 25, 25, 9.50, 1.50, 1.25, 108.50, 121.25),
('6667778880', 8, 26, 'Esteban Cruz', '2023-10-26', 'Producto Z', 'Litros', 'Tarjeta de Crédito', 26, 26, 12.99, 2.25, 1.75, 93.38, 110.12),
('1112223331', 15, 27, 'Camila González', '2023-10-27', 'Producto AA', 'Kilogramos', 'Efectivo', 27, 27, 6.25, 1.00, 0.75, 90.94, 105.44),
('9998887770', 7, 28, 'Diego Rodríguez', '2023-10-28', 'Producto BB', 'Unidades', 'Tarjeta de Débito', 28, 28, 14.50, 2.75, 2.25, 101.50, 118.25),
('4445556660', 10, 29, 'Natalia Sánchez', '2023-10-29', 'Producto CC', 'Cajas', 'Tarjeta de Crédito', 29, 29, 10.75, 2.00, 1.50, 94.50, 110.75),
('7776665550', 12, 30, 'Gabriel López', '2023-10-30', 'Producto DD', 'Litros', 'Efectivo', 30, 30, 8.25, 1.25, 1.00, 88.38, 98.63),
('3334445551', 6, 1, 'Juan Pérez', '2023-11-01', 'Producto A', 'Unidades', 'Tarjeta de Crédito', 31, 31, 11.99, 2.50, 1.75, 64.45, 79.69),
('6667778882', 9, 2, 'María Rodríguez', '2023-11-02', 'Producto B', 'Cajas', 'Efectivo', 32, 32, 18.50, 3.75, 2.25, 87.25, 111.50),
('1112223333', 7, 3, 'Carlos García', '2023-11-03', 'Producto C', 'Kilogramos', 'Tarjeta de Débito', 33, 33, 7.25, 1.50, 1.00, 58.25, 66.75),
('9998887774', 11, 4, 'Ana Gómez', '2023-11-04', 'Producto D', 'Litros', 'Tarjeta de Crédito', 34, 34, 10.99, 2.25, 1.50, 80.68, 94.17),
('4445556665', 8, 5, 'Luisa Martínez', '2023-11-05', 'Producto E', 'Unidades', 'Efectivo', 35, 35, 14.75, 3.00, 2.00, 95.00, 114.00),
('7776665556', 13, 6, 'Pedro Sánchez', '2023-11-06', 'Producto F', 'Cajas', 'Tarjeta de Débito', 36, 36, 12.50, 2.75, 2.25, 101.25, 116.00),
('2223334447', 5, 7, 'Carmen López', '2023-11-07', 'Producto G', 'Kilogramos', 'Tarjeta de Crédito', 37, 37, 6.99, 1.25, 1.00, 39.94, 47.19),
('5556667778', 10, 8, 'Pedro Hernández', '2023-11-08', 'Producto H', 'Litros', 'Efectivo', 38, 38, 11.25, 2.00, 1.50, 78.75, 92.50),
('8889990003', 12, 9, 'Laura Gómez', '2023-11-09', 'Producto I', 'Unidades', 'Tarjeta de Débito', 39, 39, 9.50, 1.50, 1.00, 84.50, 95.00),
('3334445554', 6, 10, 'Javier Fernández', '2023-11-10', 'Producto J', 'Cajas', 'Tarjeta de Crédito', 40, 40, 15.50, 2.75, 2.25, 62.00, 80.75),
('6667778885', 11, 11, 'Carmen Morales', '2023-11-11', 'Producto K', 'Kilogramos', 'Efectivo', 41, 41, 7.75, 1.00, 0.50, 42.75, 51.25),
('1112223336', 8, 12, 'Ricardo Castro', '2023-11-12', 'Producto L', 'Litros', 'Tarjeta de Débito', 42, 42, 10.50, 2.00, 1.25, 60.00, 71.75),
('9998887773', 6, 13, 'Isabel Vega', '2023-11-13', 'Producto M', 'Unidades', 'Tarjeta de Crédito', 43, 43, 13.99, 2.50, 2.00, 58.45, 74.94),
('4445556666', 10, 14, 'Fernando Torres', '2023-11-14', 'Producto N', 'Cajas', 'Efectivo', 44, 44, 9.25, 1.75, 1.00, 75.75, 86.00),
('7776665559', 13, 15, 'Natalia Soto', '2023-11-15', 'Producto O', 'Kilogramos', 'Tarjeta de Crédito', 45, 45, 12.50, 2.25, 1.75, 98.75, 113.00),
('2223334440', 7, 16, 'Santiago Pérez', '2023-11-16', 'Producto P', 'Litros', 'Efectivo', 46, 46, 8.99, 1.50, 1.00, 62.93, 74.42),
('5556667771', 9, 17, 'Alicia Mendoza', '2023-11-17', 'Producto Q', 'Unidades', 'Tarjeta de Crédito', 47, 47, 11.50, 2.25, 1.75, 87.50, 101.25),
('8889990006', 14, 18, 'Gustavo Soto', '2023-11-18', 'Producto R', 'Kilogramos', 'Tarjeta de Débito', 48, 48, 14.75, 2.00, 1.50, 124.38, 140.12),
('3334445557', 8, 19, 'Adriana Guzmán', '2023-11-19', 'Producto S', 'Cajas', 'Efectivo', 49, 49, 11.99, 2.50, 2.00, 78.41, 91.90),
('6667778888', 12, 20, 'Rodrigo Torres', '2023-11-20', 'Producto T', 'Unidades', 'Tarjeta de Crédito', 50, 50, 7.25, 1.25, 1.25, 96.75, 112.50);